...
/**
 * DTO pour la réponse de filtrage des propositions
 */
data class ProposalFilterResponseDto(
    @SerializedName("proposals") val proposals: List<com.example.matchify.data.remote.dto.proposal.ProposalDto>,
    @SerializedName("total") val total: Int? = null,
    @SerializedName("page") val page: Int? = null,
    @SerializedName("limit") val limit: Int? = null,
    @SerializedName("averageScore") val averageScore: Double? = null // Score moyen des propositions filtrées
)
